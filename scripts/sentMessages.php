<?php
    ...
    $result2= pg_prepare($bdd,"query2",'SELECT idmessage, objet, contenu, dateenvoi, etat, idemetteur,idrecepteur, nom, prenom FROM messages, utilisateurs WHERE messages.idrecepteur = utilisateurs.iduser AND idemetteur = $1 ORDER BY dateenvoi DESC;');
