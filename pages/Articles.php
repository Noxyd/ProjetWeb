    ...
    <div id="wrap-container">
      ...
      <nav>
        <ul id="wrap-li">
          ...
          <li class="actif"><a href="/pages/Publications.php"> Publications </a></li>
     ...
     <div class="wrap-content">
        <div id="left-panel">
            ...
            <form name="insert" action="../scripts/Ajout.php" method="POST">
     ...
     <div id="right-panel">
         ...
         <a href="../pages/Publications.php" class="btn-fieldset btn btn-primary">Retour à mes publications</a>
             </div>
          <div id="calendrier">
